...
<%
        ...
        try{
		    ...
		    ResultSet rs=stmt.executeQuery("Select * from student_info where studentId='"+studentId+"';");
		    while(rs.next())
			{
			...
			ResultSet rs1=stmt1.executeQuery("Select * from student_address where studentId='"+studentId+"';");
			while(rs1.next())
			{
			...
			ResultSet rs2=stmt2.executeQuery("Select * from student_academic where studentId='"+studentId+"';");
			while(rs2.next())
			{
		    ...
		    ResultSet rs3=stmt3.executeQuery("Select * from student_college where studentId='"+studentId+"';");
			while(rs3.next())
			{	
			uniName=rs3.getString("uniName");
			collName=rs3.getString("collName");
			yGrad=rs3.getString("yGrad");
			}
		    
			 ResultSet rs4=stmt4.executeQuery("Select * from student_contact where studentId='"+studentId+"';");
			while(rs4.next())
			{	
...
%>
<div class="container">
     <h1 class="Display-1 text-center">Student Registration</h1>
<div class="row">
    <div class="col-md-8 col-md-offset-1">
      <form class="form-horizontal" role="form" action="http://localhost:8080/examples/project2/studentupdaterecord.jsp">
        <fieldset>
...
<!-- Emergency Contact Section -->
          ...
          <div class="form-group">
		      ...
		      <div class="row">
			     <div class="col-lg-5 text-center">
				    <p>Current Year Of Graduation:</p>
				 </div>
		  
	              <div class="col-lg-3 ">
				     <input type="text" name="yGrad" placeholder="Ex:3 " class="form-control" value="<%=yGrad%>">
				  </div>
			  </div>
          ...
          <div class="form-group">
		      ...
		      <div class="row">
			     <div class="col-lg-3 text-center">
	              ...
	              <div class="col-lg-6">
				     <input type="text" name="studentId" placeholder="Ex:Aktu" class="form-control" value="<%=studentId%>">
				  </div>
			  </div>
